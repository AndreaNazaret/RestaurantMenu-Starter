...
public class MenuEspressoTests {


    MenuEspressoSteps steps = new MenuEspressoSteps();

    @Rule
    public ActivityTestRule<SectionsActivity> testRule =
            new ActivityTestRule<>(SectionsActivity.class);
...
//    steps.appShowPriceOnItem("8 euros", "Second Dessert");
        ...
        // When
        steps.userRotateScreen(testRule.getActivity().getRequestedOrientation());
